...
<script>
	...
	import MsgCell from 'components/common/message/msg-cell';

	import 'assets/styles/home/home.scss';
	import 'assets/styles/message/message.scss';
	export default {
		data() {
			return {
				messageHeads: [
				...
				lookedMeTitle: `src/assets/images/main-nav03.png`,
				allDialog: [
					{
						img: `src/assets/images/main-nav01.png`,
						content: {
							title: `one`,
					...
					{
						img: `src/assets/images/main-nav02.png`,
						content: {
							title: `two`,
							description: `12345678`,
						},
					...
					{
						img: `src/assets/images/main-nav04.png`,
						content: {
							title: `three`,
							description: `12345678`,
						},
